...
AppState reducer(AppState prev, action){
  ...
  if (action is AddTaskAction) {
    ...
    return AppState(
        editTaskReducer(prev, action.editedTask, action.editedTaskId, action.result));
...
List<Map<String, dynamic>> editTaskReducer(
    AppState prev, String editedTask, int editedTaskId, List<Map<String, dynamic>> result) {

  return result;
}

List<Map<String, dynamic>> syncTaskReducer(AppState prev, List<Map<String, dynamic>> result) {
